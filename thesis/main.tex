...
\input{chapters/03-materialy-metody}
\input{chapters/04-klasyfikator}
\input{chapters/06-rekomendacje}
\input{chapters/07-wrazliwosc}
\input{chapters/08-dyskusja-wnioski}
