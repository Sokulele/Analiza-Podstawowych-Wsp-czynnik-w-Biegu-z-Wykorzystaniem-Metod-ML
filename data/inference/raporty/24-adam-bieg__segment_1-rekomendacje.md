...
**Wideo**: 24 - Adam bieg__segment_1
**Pewność predykcji modelu**: 0.91

## Podsumowanie

- 🔴 Krytyczne: **0**  🟠 Ostrzeżenia: **2**  🟡 Do monitorowania: **1**  ℹ️ Informacje: **5**
- Łącznie reguł zwracających wynik: 8
...
Pochylenie tułowia < 5° (lub ujemne) oznacza brak wykorzystania grawitacji do napędu. Lekkie pochylenie z kostek (5–15°) wykorzystuje siłę ciężkości i obniża obciążenie nóg. UWAGA: wartość ta bywa zaniżona przez ograniczenia MediaPipe 2D — zweryfikuj wzrokowo.

**Pomiar**: pochylenie tułowia: 2.3° (cel: 5–15°)

**Sugestia**: Ćwicz pochylenie 'z kostek, nie z bioder' (forward lean from ankles).
...
**Pomiar**: GCT (czas kontaktu) SI=18.7%; duty factor SI=18.7%
...
**Pomiar**: kąt kostki w fazie stance SI=5.6%

---

## ℹ️ Informacja

### Kadencja w zalecanym zakresie
*Kategoria: **kadencja** · Źródło: Heiderscheit et al. 2011*

Kadencja mieści się w zakresie zalecanym dla zaawansowanych biegaczy (170–185 spm).

**Pomiar**: kadencja: 173 spm

---

### Kolano lewa przy kontakcie: prawidłowe
*Kategoria: **kolano@kontakt** · Źródło: Heiderscheit et al. 2011*

Kąt kolana 160–175° w momencie kontaktu to optymalny zakres — lekko ugięte kolano absorbuje siłę uderzenia.

**Pomiar**: kąt kolana lewa: 161.8°

---

### Kolano prawa przy kontakcie: prawidłowe
*Kategoria: **kolano@kontakt** · Źródło: Heiderscheit et al. 2011*

Kąt kolana 160–175° w momencie kontaktu to optymalny zakres — lekko ugięte kolano absorbuje siłę uderzenia.

**Pomiar**: kąt kolana prawa: 162.0°

---

### Oscylacja pionowa: ekonomiczny zakres
*Kategoria: **vert_osc** · Źródło: Diaz et al. 2019*

Oscylacja 0.12–0.16 torso (≈ 6–8 cm) to wartość typowa dla dobrych biegaczy.

**Pomiar**: vert osc / torso: 0.140
